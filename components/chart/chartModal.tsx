        ...
        <div className="flex gap-4 mt-8">
          ...
          <button
            ...
            className={`flex-1 px-6 py-4 font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg ${
              type === 'expense'
                ? 'bg-black dark:bg-white dark:from-gray-200 dark:to-gray-100 hover:from-gray-900 hover:to-black dark:hover:from-gray-100 dark:hover:to-white text-white hover:shadow-gray-800/50 dark:shadow-gray-200/50'
                : 'bg-black dark:bg-white dark:from-gray-300 dark:to-gray-200 hover:from-gray-800 hover:to-gray-900 dark:hover:from-gray-200 dark:hover:to-gray-100 text-white hover:shadow-gray-700/50 dark:shadow-gray-300/50'
            }`}
          >
